...
#include "tcn_def.h"
#endif
#if defined PROT_MVB_MD_ADDON && !defined TT_FULL
#include "tcn_mcs_cgf.h"   /* MCS_CGF_GLOBALS needs this */
#include "tcn_mcs_def.h"  /* MCS_CLCH_GLOBALS */
#endif
#ifdef PROT_MVB_SERVER
#include "mvb_md.h"
#ifndef TT_FULL
#include "mcs_cgf.h"   /* MCS_CGF_GLOBALS needs this */
#include "mcs_def.h"  /* MCS_CLCH_GLOBALS */
#endif
#endif
#include "dg_rtm.h"
#include "dg_rpc_g.h"
...
#endif
#if (DG_IO_MODE==DG_HDCFG_SPI)
#define DG_IO_MODE_ALL DG_HDCFG_SPI
#endif
...
#endif /* PROT_MVB_SERVER */

#if defined PROT_MVB_SERVER || defined PROT_MVB_MD_ADDON
...
#define DG_CARD_Y_CHANNEL_X_READ_TIMEOUT(INDEX,CARD) DG_CARD_##CARD##_CHANNEL_##INDEX##_READ_TIMEOUT    // e.g., DG_CARD_0_CHANNEL_0_READ_TIMEOUT
...
/* MDFULL / SERVER */
// CARD_MVB uses 1G
// CARD_MVB_SERVER uses 2G for NIOS versions and 1G for non-NIOS versions (D113/D215...)
// for non-NIOS versions (D113/D215...), define both DG_CARD_X_MVB_CHANNEL and DG_CARD_x_MVB_SERVER_CHANNEL as 0
// for non-NIOS versions (D113/D215...), define MVB_DEVICE_HAS_SVC_CHANNEL as 0
#if (CARD_0_TYPE==CARD_MVB) || (CARD_0_TYPE==CARD_RT_ETH_MVB) || (defined USE_OLD_UE1G_REGISTER_MAP) || (defined MVB_DEVICE_HAS_SVC_CHANNEL && MVB_DEVICE_HAS_SVC_CHANNEL==0)
...
#if (CARD_1_TYPE==CARD_MVB) || (CARD_1_TYPE==CARD_RT_ETH_MVB) || (defined USE_OLD_UE1G_REGISTER_MAP) || (defined MVB_DEVICE_HAS_SVC_CHANNEL && MVB_DEVICE_HAS_SVC_CHANNEL==0)
...
#   endif
#endif
#if (CARD_2_TYPE==CARD_MVB) || (CARD_2_TYPE==CARD_RT_ETH_MVB) || (defined USE_OLD_UE1G_REGISTER_MAP) || (defined MVB_DEVICE_HAS_SVC_CHANNEL && MVB_DEVICE_HAS_SVC_CHANNEL==0)
...
#   endif
#endif
#if (CARD_3_TYPE==CARD_MVB) || (CARD_3_TYPE==CARD_RT_ETH_MVB) || (defined USE_OLD_UE1G_REGISTER_MAP) || (defined MVB_DEVICE_HAS_SVC_CHANNEL && MVB_DEVICE_HAS_SVC_CHANNEL==0)
...
#define DG_CARD_0_CHANNEL_0_READ_TIMEOUT 6000   // MVB_SERVER needs at least 6s
#endif
...
#endif
#ifndef DG_CARD_0_SERIAL_CHANNEL_0_DEV
#define DG_CARD_0_SERIAL_CHANNEL_0_DEV "/dev/ttyUSB0"
#endif
#ifndef DG_CARD_1_SERIAL_CHANNEL_0_DEV
#define DG_CARD_1_SERIAL_CHANNEL_0_DEV "/dev/ttyUSB0"
#endif
#ifndef DG_CARD_2_SERIAL_CHANNEL_0_DEV
#define DG_CARD_2_SERIAL_CHANNEL_0_DEV "/dev/ttyUSB0"
#endif
#ifndef DG_CARD_3_SERIAL_CHANNEL_0_DEV
#define DG_CARD_3_SERIAL_CHANNEL_0_DEV "/dev/ttyUSB0"
#endif
#ifndef DG_CARD_0_SERIAL_CHANNEL_1_DEV
#define DG_CARD_0_SERIAL_CHANNEL_1_DEV "/dev/ttyUSB0"
#endif
#ifndef DG_CARD_1_SERIAL_CHANNEL_1_DEV
#define DG_CARD_1_SERIAL_CHANNEL_1_DEV "/dev/ttyUSB0"
#endif
#ifndef DG_CARD_2_SERIAL_CHANNEL_1_DEV
#define DG_CARD_2_SERIAL_CHANNEL_1_DEV "/dev/ttyUSB0"
#endif
#ifndef DG_CARD_3_SERIAL_CHANNEL_1_DEV
#define DG_CARD_3_SERIAL_CHANNEL_1_DEV "/dev/ttyUSB0"
#endif
#ifndef DG_CARD_0_SERIAL_CHANNEL_2_DEV
#define DG_CARD_0_SERIAL_CHANNEL_2_DEV "/dev/ttyUSB0"
#endif
#ifndef DG_CARD_1_SERIAL_CHANNEL_2_DEV
#define DG_CARD_1_SERIAL_CHANNEL_2_DEV "/dev/ttyUSB0"
#endif
#ifndef DG_CARD_2_SERIAL_CHANNEL_2_DEV
#define DG_CARD_2_SERIAL_CHANNEL_2_DEV "/dev/ttyUSB0"
#endif
#ifndef DG_CARD_3_SERIAL_CHANNEL_2_DEV
#define DG_CARD_3_SERIAL_CHANNEL_2_DEV "/dev/ttyUSB0"
#endif
