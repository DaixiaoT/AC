 ...
 *              key = 点??       Returns the number of tree elements below 
 *                                the root of the tree.
 *              key = 点?x?      Returns the name of the x-th tree entry
 *                                below the root of the tree if existent.
 *                                (x=0: 1st element, x=1: 2nd element etc.)
 *              key = 電evice_?? Returns the number of tree elements in the
 *                                ''device'' branch.
 *              key = 電evice_?x?Returns the name of the x-th tree element
