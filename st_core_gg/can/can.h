...
#define CAN_NUM (2)
#define IAP_BUS_UART0 (CAN_NUM)
#define IAP_BUS_NET   (IAP_BUS_UART0+1)
#define IAP_BUS_USB   (IAP_BUS_UART0+2)
#define IAP_BUS_UART4   (IAP_BUS_UART0+3)
#define IAP_BUS_UART3   (IAP_BUS_UART0+4)
