...
enum HVAC_PROJECT
{
	IAP_HVAC_EMU = (0x14 << 8),  //上海利勃海尔 EMU 模块
	IAP_HVAC_CAB = (0x15 << 8),  //上海利勃海尔 CAB 模块

	IAP_HVAC_UAE_EMU = (0x16 << 8),  //上海利勃海尔 EMU 模块 阿联酋项目
    IAP_HVAC_UAE_CAB = (0x17 << 8),  //上海利勃海尔 UAE CAB 模块 阿联酋项目
