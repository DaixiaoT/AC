...
typedef struct TRDP_COMM_DATA
{
	...
	BOOLEAN1	CCU_Cab2Opera_B2 : 1;		//	4	b6	1	司机室2激活	7车主控	1=激活；0=无效		
	...
	UNSIGNED8	Car5Axle2Wheel_H_U8;		//	24		8	5车2轴轮径H	轮径值高字节	1=1mm		
	UNSIGNED8	Car5Axle2Wheel_L_U8;		//	25		8	5车2轴轮径L	轮径值低字节	1=1mm		
	UNSIGNED8	Car6Axle2Wheel_H_U8;		//	26		8	6车2轴轮径H	轮径值高字节	1=1mm		
	UNSIGNED8	Car6Axle2Wheel_L_U8;		//	27		8	6车2轴轮径L	轮径值低字节	1=1mm		
	UNSIGNED8	Car7Axle2Wheel_H_U8;		//	28		8	7车2轴轮径H	轮径值高字节	1=1mm		
	UNSIGNED8	Car7Axle2Wheel_L_U8;		//	29		8	7车2轴轮径L	轮径值低字节	1=1mm

	UNSIGNED8	CCU_BYTE30;					//	30		8
	UNSIGNED8	CCU_BYTE31;					//	31		8					
	UNSIGNED8	CCU_PBValue_U8;				//	32		8	牵引制动级位	0-7对应0到7级	1=1	0-7	

	UNSIGNED8	CCU_BYTE33;					//	33	
	UNSIGNED8	CCU_BYTE34;					//	34
	UNSIGNED8	CCU_BYTE35;					//	35
	UNSIGNED8	CCU_BYTE36;					//	36
	UNSIGNED8	CCU_BYTE37;					//	37
	UNSIGNED8	CCU_BYTE38;					//	38
	UNSIGNED8	CCU_BYTE39;					//	39
	UNSIGNED8	CCU_BYTE40;					//	40
	UNSIGNED8	CCU_BYTE41;					//	41
	UNSIGNED8	CCU_BYTE42;					//	42
	UNSIGNED8	CCU_BYTE43;					//	43
	UNSIGNED8	CCU_BYTE44;					//	44
	UNSIGNED8	CCU_BYTE45;					//	45
	UNSIGNED8	CCU_BYTE46;					//	46

	UNSIGNED8	Car1Axle3Wheel_H_U8;		//	47		8	1车3轴轮径H	轮径值高字节	1=1mm
	UNSIGNED8	Car1Axle3Wheel_L_U8;		//	48		8	1车3轴轮径L	轮径值低字节	1=1mm
	UNSIGNED8	Car7Axle3Wheel_H_U8;		//	49		8	7车3轴轮径H	轮径值高字节	1=1mm
	UNSIGNED8	Car7Axle3Wheel_L_U8;		//	50		8	7车3轴轮径L	轮径值低字节	1=1mm

	UNSIGNED8	CCU_HVAC_OutT_U8;			//	51		8	车外温度	温度设定值0-255对应-20℃ ~ 107.5℃，40对应 0°，最小设定单位为“0.5℃”	0xFF 无效

	UNSIGNED8	res[48];					//	预留48字节，总长度100字节
};
...
typedef struct TRDP_CCU2HVAC
{
	...
	//BYTE4
	BOOLEAN1	CCU_BYTE4_BIT0 : 1;				//	4	b0	预留			
	BOOLEAN1	CCU_BYTE4_BIT1 : 1;				//	4	b1	预留			
	BOOLEAN1	CCU_BYTE4_BIT2 : 1;				//	4	b2	预留
	BOOLEAN1	CCU_BYTE4_BIT3 : 1;				//	4	b3	预留
	BOOLEAN1	CCU_BYTE4_BIT4 : 1;				//	4	b4	预留
	BOOLEAN1	CCU_BYTE4_BIT5 : 1;				//	4	b5	预留
	BOOLEAN1	CCU_HVAC_HalfLoad_B1 : 1;		//	4	b6	空调减载	减载=1，非减载=0	收到信号1之后进入减载，收到0后退出减载。			
	...
	BOOLEAN1	CCU_HVAC_EMV_B1 : 1;				//	5	b3	1	紧急通风信号			1=进入紧急通风模式，0=退出紧急通风模式	0-1	仅在模式开关切换至AUTO档位时才会进入。机组拥有纯硬线紧急通风功能，故软件仅为备用方案，无安全功能
	BOOLEAN1	CCU_BYTE5_BIT4 : 1;				//	5	b4	1	预留
	BOOLEAN1	CCU_BYTE5_BIT5 : 1;				//	5	b5	1	预留
	BOOLEAN1	CCU_BYTE5_BIT6 : 1;				//	5	b6	1	预留
	BOOLEAN1	CCU_BYTE5_BIT7 : 1;				//	5	b7	1	预留
	//BYTE6
	UNSIGNED8	CCU_BYTE6;						//	6	8	预留
	...
	UNSIGNED8	CCU_BYTE9;						//	9	8	预留				
	UNSIGNED8	CCU_BYTE10;						//	10	8	预留
	UNSIGNED8	CCU_BYTE11;						//	11	8	预留		
	UNSIGNED8	CCU_BYTE12;						//	12	8	预留				
	UNSIGNED8	CCU_BYTE13;						//	13	8	预留
	UNSIGNED8	CCU_BYTE14;						//	14	8	预留		
	UNSIGNED8	CCU_BYTE15;						//	15	8	预留		
	UNSIGNED8	CCU_BYTE16;						//	16	8	预留
	//BYTE17
	BOOLEAN1	CCU_BYTE17_BIT0 : 1;					//	17	b0	1	预留
	BOOLEAN1	CCU_HVAC_Car7Start_B1 : 1;		//	17	b1	1	7车压缩机允许启动信号	1=允许启动，0=不允许启动	0-1	空调只能在对应窗口内启动压缩机
	BOOLEAN1	CCU_HVAC_Car6Start_B1 : 1;		//	17	b2	2	6车压缩机允许启动信号	1=允许启动，0=不允许启动	0-1	空调只能在对应窗口内启动压缩机
	BOOLEAN1	CCU_HVAC_Car5Start_B1 : 1;		//	17	b3	1	5车压缩机允许启动信号	1=允许启动，0=不允许启动	0-1	空调只能在对应窗口内启动压缩机
	BOOLEAN1	CCU_HVAC_Car4Start_B1 : 1;		//	17	b4	1	4车压缩机允许启动信号	1=允许启动，0=不允许启动	0-1	空调只能在对应窗口内启动压缩机
	BOOLEAN1	CCU_HVAC_Car3Start_B1 : 1;		//	17	b5	1	3车压缩机允许启动信号	1=允许启动，0=不允许启动	0-1	空调只能在对应窗口内启动压缩机
	BOOLEAN1	CCU_HVAC_Car2Start_B1 : 1;		//	17	b6	1	2车压缩机允许启动信号	1=允许启动，0=不允许启动	0-1	空调只能在对应窗口内启动压缩机
	...
	BOOLEAN1	CCU_HVAC_Car4TempModeSet_B1 : 1;	//	18	b4	1	4车温度模式设置	BOOL	3s脉冲	温度设定=1，温度未设定=0	0-1	温度模式设置有效时，更改温度和模式
	BOOLEAN1	CCU_HVAC_Car3TempModeSet_B1 : 1;	//	18	b5	1	3车温度模式设置	BOOL	3s脉冲	温度设定=1，温度未设定=0	0-1	温度模式设置有效时，更改温度和模式
	BOOLEAN1	CCU_HVAC_Car2TempModeSet_B1 : 1;	//	18	b6	1	2车温度模式设置	BOOL	3s脉冲	温度设定=1，温度未设定=0	0-1	温度模式设置有效时，更改温度和模式
	BOOLEAN1	CCU_HVAC_Car1TempModeSet_B1 : 1;	//	18	b7	1	1车温度模式设置	BOOL	3s脉冲	温度设定=1，温度未设定=0	0-1	温度模式设置有效时，更改温度和模式

	UNSIGNED8	CCU_BYTE19;						//	19	8	预留
	UNSIGNED8	CCU_BYTE20;						//	20	8	预留

	UNSIGNED8	CCU_HVAC_Car1Mode_U8;			//	21	8	1车模式设定值		01:通风 02:全热 03:制冷 04:自动 05:停止 06: 半热		
	UNSIGNED8	CCU_HVAC_Car2Mode_U8;			//	22	8	2车模式设定值		01:通风 02:全热 03:制冷 04:自动 05:停止 06: 半热		
	UNSIGNED8	CCU_HVAC_Car3Mode_U8;			//	23	8	3车模式设定值		01:通风 02:全热 03:制冷 04:自动 05:停止 06: 半热		
	UNSIGNED8	CCU_HVAC_Car4Mode_U8;			//	24	8	4车模式设定值		01:通风 02:全热 03:制冷 04:自动 05:停止 06: 半热		
	UNSIGNED8	CCU_HVAC_Car5Mode_U8;			//	25	8	5车模式设定值		01:通风 02:全热 03:制冷 04:自动 05:停止 06: 半热		
	UNSIGNED8	CCU_HVAC_Car6Mode_U8;			//	26	8	6车模式设定值		01:通风 02:全热 03:制冷 04:自动 05:停止 06: 半热		
	UNSIGNED8	CCU_HVAC_Car7Mode_U8;			//	27	8	7车模式设定值		01:通风 02:全热 03:制冷 04:自动 05:停止 06: 半热		
	UNSIGNED8	CCU_BYTE28;						//	28	8	预留	

	UNSIGNED8	CCU_BYTE29;						//	29	8	预留
	UNSIGNED8	CCU_BYTE30;						//	30	8	预留
	UNSIGNED8	CCU_BYTE31;						//	31	8	预留

	UNSIGNED8	CCU_HVAC_Car2Temp_U8;			//	32	8	2车温度设定值		温度设定值0-255对应-20℃ ~ 107.5℃，40对应 0°，最小设定单位为“0.5℃”		温度模式设置有效时采信温度设定值
	UNSIGNED8	CCU_HVAC_Car3Temp_U8;			//	33	8	3车温度设定值		温度设定值0-255对应-20℃ ~ 107.5℃，40对应 0°，最小设定单位为“0.5℃”		
	UNSIGNED8	CCU_HVAC_Car4Temp_U8;			//	34	8	4车温度设定值		温度设定值0-255对应-20℃ ~ 107.5℃，40对应 0°，最小设定单位为“0.5℃”		温度模式设置有效时采信温度设定值
	UNSIGNED8	CCU_HVAC_Car5Temp_U8;			//	35	8	5车温度设定值		温度设定值0-255对应-20℃ ~ 107.5℃，40对应 0°，最小设定单位为“0.5℃”		
	UNSIGNED8	CCU_HVAC_Car6Temp_U8;			//	36	8	6车温度设定值		温度设定值0-255对应-20℃ ~ 107.5℃，40对应 0°，最小设定单位为“0.5℃”		温度模式设置有效时采信温度设定值

	//BYTE37
	BOOLEAN1	CCU_BYTE37_BIT0 : 1;				//	37	b0	1	预留
	BOOLEAN1	CCU_BYTE37_BIT1 : 1;				//	37	b1	1	预留
	BOOLEAN1	CCU_BYTE37_BIT2 : 1;				//	37	b2	1	预留
	BOOLEAN1	CCU_BYTE37_BIT3 : 1;				//	37	b3	1	预留
	BOOLEAN1	CCU_BYTE37_BIT4 : 1;				//	37	b4	1	预留
	BOOLEAN1	CCU_SIV3OK_B1 : 1;				//	37	b5	1	辅助逆变器SIV3状态OK	CCU_SIV3OK_B1				
	BOOLEAN1	CCU_SIV2OK_B1 : 1;				//	37	b6	1	辅助逆变器SIV2状态OK	CCU_SIV2OK_B1				
	BOOLEAN1	CCU_SIV1OK_B1 : 1;				//	37	b7	1	辅助逆变器SIV1状态OK	CCU_SIV1OK_B1				


	UNSIGNED8	res[62];						//预留62字节，总长度100字节
};
...
typedef struct TRDP_HVAC2CCU
{
	...
	UNSIGNED8	HVACCs_OpMo_S_X_U8;				//	6		8	X车司机室工作模式	司机室紧急通风状态新风门打开 接收到洗车模式后，执行器动作执行结束后，反馈洗车信号	01:全暖 02:半暖 03:全冷 05:通风 06:自动 07:停止 08:火灾 09:紧急通风 10:洗车 11:应急模式	1-11			
	...
	BOOLEAN1	HVACCs_EMC_S_X_B : 1;			//	32	b3	1	X车司机室应急模式状态激活	空调执行应急模式后反馈=1	1=激活，0=未激活	0-1			
	BOOLEAN1	HVAC_BYTE32_BIT4 : 1;			//	32	b4	1	预留			
	BOOLEAN1	HVAC_BYTE32_BIT5 : 1;			//	32	b5	1	预留			
	...
	BOOLEAN1	HVAC_BYTE34_BIT0 : 1;			//	34	b0	1	预留			
	BOOLEAN1	HVAC_BYTE34_BIT1 : 1;			//	34	b1	1	预留			
	BOOLEAN1	HVAC_BYTE34_BIT2 : 1;			//	34	b2	1	预留
	BOOLEAN1	HVACCs_alarm_Level_5 : 1;			//	34	b3	1	X车司机室故障等级5
	BOOLEAN1	HVACCs_alarm_Level_4 : 1;			//	34	b4	1	X车司机室故障等级4
	BOOLEAN1	HVACCs_alarm_Level_3 : 1;			//	34	b5	1	X车司机室故障等级3
	BOOLEAN1	HVACCs_alarm_Level_2 : 1;			//	34	b6	1	X车司机室故障等级2
	BOOLEAN1	HVACCs_alarm_Level_1 : 1;			//	34	b7	1	X车司机室故障等级1


	UNSIGNED8	HVAC_BYTE35;					//	35		8	预留		
	...
	BOOLEAN1	HVAC_BYTE39_BIT2 : 1;			//	39	b2	1	预留			
	BOOLEAN1	HVAC_BYTE39_BIT3 : 1;			//	39	b3	1	预留			
	...
	BOOLEAN1	HVAC_BYTE40_BIT0 : 1;			//	40	b0	1	预留			
	BOOLEAN1	HVAC_BYTE40_BIT1 : 1;			//	40	b1	1	预留			
	BOOLEAN1	HVAC_BYTE40_BIT2 : 1;			//	40	b2	1	预留			
	BOOLEAN1	HVAC_BYTE40_BIT3 : 1;			//	40	b3	1	预留			
	...
	BOOLEAN1	HVAC_BYTE41_BIT6 : 1;			//	41	b6	1	预留			
	BOOLEAN1	HVAC_BYTE41_BIT7 : 1;			//	41	b7	1	预留	

	BOOLEAN1	HVAC_BYTE42_BIT0 : 1;			//	42	b0	1	预留			
	BOOLEAN1	HVAC_BYTE42_BIT1 : 1;			//	42	b1	1	预留			
	BOOLEAN1	HVAC_BYTE42_BIT2 : 1;			//	42	b2	1	预留			
	BOOLEAN1	HVAC_BYTE42_BIT3 : 1;			//	42	b3	1	预留			
	...
	BOOLEAN1	HVAC_BYTE43_BIT0 : 1;			//	43	b0	1	预留			
	BOOLEAN1	HVAC_BYTE43_BIT1 : 1;			//	43	b1	1	预留			
	BOOLEAN1	HVAC_BYTE43_BIT2 : 1;			//	43	b2	1	预留
	BOOLEAN1	HVACS1s_alarm_Level_5 : 1;		//	43	b3	1	X车客室机组1故障等级5		1=有故障，0=无故障
	BOOLEAN1	HVACS1s_alarm_Level_4 : 1;		//	43	b4	1	X车客室机组1故障等级4		1=有故障，0=无故障
	BOOLEAN1	HVACS1s_alarm_Level_3 : 1;		//	43	b5	1	X车客室机组1故障等级3		1=有故障，0=无故障
	BOOLEAN1	HVACS1s_alarm_Level_2 : 1;		//	43	b6	1	X车客室机组1故障等级2		1=有故障，0=无故障
	BOOLEAN1	HVACS1s_alarm_Level_1 : 1;		//	43	b7	1	X车客室机组1故障等级1		1=有故障，0=无故障

	BOOLEAN1	HVAC_BYTE44_BIT0 : 1;			//	44	b0	1	预留			
	BOOLEAN1	HVAC_BYTE44_BIT1 : 1;			//	44	b1	1	预留			
	BOOLEAN1	HVAC_BYTE44_BIT2 : 1;			//	44	b2	1	预留
	BOOLEAN1	HVACS2s_alarm_Level_5 : 1;		//	44	b3	1	X车客室机组2故障等级5		1=有故障，0=无故障
	BOOLEAN1	HVACS2s_alarm_Level_4 : 1;		//	44	b4	1	X车客室机组2故障等级4		1=有故障，0=无故障
	BOOLEAN1	HVACS2s_alarm_Level_3 : 1;		//	44	b5	1	X车客室机组2故障等级3		1=有故障，0=无故障
	BOOLEAN1	HVACS2s_alarm_Level_2 : 1;		//	44	b6	1	X车客室机组2故障等级2		1=有故障，0=无故障
	BOOLEAN1	HVACS2s_alarm_Level_1 : 1;		//	44	b7	1	X车客室机组2故障等级1		1=有故障，0=无故障

	BOOLEAN1	HVAC_BYTE45_BIT0 : 1;			//	45	b0	1	预留			
	BOOLEAN1	HVAC_BYTE45_BIT1 : 1;			//	45	b1	1	预留			
	BOOLEAN1	HVAC_BYTE45_BIT2 : 1;			//	45	b2	1	预留
	BOOLEAN1	HVAC_BYTE45_BIT3 : 1;			//	45	b3	1	预留			
	BOOLEAN1	HVAC_BYTE45_BIT4 : 1;			//	45	b4	1	预留			
	BOOLEAN1	HVAC_BYTE45_BIT5 : 1;			//	45	b5	1	预留
	BOOLEAN1	HVAC_BYTE45_BIT6 : 1;			//	45	b6	1	预留
	BOOLEAN1	HVACSs_WCEAF_S_X_B : 1;			//	45	b7	1	X车客室厕所废排风机状态		1=启动，0=未启动
	...
	BOOLEAN1	HVACSs_CO2_E_X_B : 1;			//	66	b0	1	X车客室CO2传感器故障				1=故障，0=没有故障
	...
	BOOLEAN1	HVAC_BYTE68_BIT0 : 1;			//	68	b0	1	预留	
	BOOLEAN1	HVAC_BYTE68_BIT1 : 1;			//	68	b1	1	预留
	BOOLEAN1	HVAC_BYTE68_BIT2 : 1;				//	68	b2	1	预留
	BOOLEAN1	HVACSs_EAF_E_X_B : 1;				//	68	b3	1	X车客室废排风机故障	
	BOOLEAN1	HVACSs_HU_E_X_B : 1;				//	68	b4	1	X车客室制热异常	
	BOOLEAN1	HVACSs_TL_E_X_B : 1;				//	68	b5	1	X车客室温度过低	
	BOOLEAN1	HVACSs_CU_E_X_B : 1;				//	68	b6	1	X车客室制冷异常	
	BOOLEAN1	HVACSs_TH_E_X_B : 1;				//	68	b7	1	X车客室温度过高	
