...
void ACControl::ProcessMode()
{
	...
	LOG_AC("CCU_Lifesign_U32 mode:%08x\n", hton32(g_ccutohavcdata.CCU_Lifesign_U32));
...
{
	LOG_AC("自检中： 开始时间：%d, 持续时长：%d\n", selfTestStartTime, selfTestLastTime);
